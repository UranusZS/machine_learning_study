...
tf.flags.DEFINE_integer("rnn_hidden_size", 128, "rnn_hidden_size (default: 128)")
tf.flags.DEFINE_integer("rnn_seq_len", 4, "rnn_seq_len (default: 4)")
        ...
        with tf.Session(config=session_conf) as sess:
            ...
            def train_step(x_batch, y_batch):
                ...
                feed_dict = {
                    ...
                    cnn_text.batch_size: batch_size
                }
...
def evaluate():
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            predictions = graph.get_operation_by_name("net_output/predictions").outputs[0]
