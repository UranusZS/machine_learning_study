...
// a big number that bigger than the number of used features
#define UNUSED_FEATURE_ID -1
// a big number that bigger than the number of classes
#define UNUSED_LABEL_ID -1
